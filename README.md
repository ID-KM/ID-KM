...
<style>
  ...
  <text x="400" y="155" text-anchor="middle" class="sky-text" style="font-size:26px;">فَإِنَّ مَعَ الْعُسْرِ يُسْرًا</text>
  <!-- Clouds -->
  <g class="cloud-1 cld">
  ...
  <g class="sil">
    <!-- Main Dome -->
    <path d="M 285,305 L 285,258 Q 285,228 315,210 Q 330,200 340,210 Q 370,228 370,258 L 370,305 Z"/>
    <!-- Dome Finial (Hilal) -->
  ...
  <g class="sil">
    <!-- Trunk -->
    <path d="M 668,305 L 665,278 Q 662,268 666,258 L 670,248 Q 674,252 672,260 L 676,278 L 674,305 Z"/>
    <!-- Branch -->
    <path d="M 668,265 Q 660,255 648,258 Q 640,260 638,252" fill="none" stroke="#070a18" stroke-width="2.5"/>
    <!-- Canopy layers -->
  ...
  <!-- Subtle ground vegetation hints -->
  <g opacity="0.25">
...
<!-- Watermelon Palestine Symbol (SVG) -->
